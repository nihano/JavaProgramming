...
public class MapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        for (String name : employeeMap.keySet()) {
            String  gender = employeeMap.get(name); //name is the key
            if (gender.equals("M")){
                countMaleEmployee++;
            }else {
        ...
        for (Map.Entry<String, String> eachEntry : employeeMap.entrySet()) {
           if (eachEntry.getValue().equals("F")){ // value is equal to "F"
               System.out.println(eachEntry.getKey());// print the key (female emoloyee names)
           }
        }
