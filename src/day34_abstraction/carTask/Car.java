...
public abstract class Car { //abstract means meanth to be inherited and cannot be instantiated
    ...
    protected final void stop(){ // to make sure that non subclasses outside the package cannot access it
