package day39_collections_completeClassesFromGitHub;
...
public class SetDemo {
    ...
    public static void main(String[] args) {
       ...
       // result.get(1); set does not have index numbers
        ...
        words = result.toArray(new String[0]); // converted LinkedHashSet to Array. array is faster and has index numbers
        ...
        SortedSet<Integer> n = new TreeSet<>(numbers); // remove duplicates and sorted order
