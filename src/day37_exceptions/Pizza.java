...
public class Pizza {
    ...
    public boolean equals(Object obj) {
        ...
        Pizza pizza = (Pizza)obj; // we can assign it to a variable and reuse the variable instead of downcast each time
        if (size == pizza.size) { // we can use the getter as well, but we are in the same class that's ok
