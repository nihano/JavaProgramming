...
public final class CydeoDevStudent extends Person { // this class can never be inherited because final
    ...
    public CydeoDevStudent(String name, char gender, LocalDate dateOfBirth, String id, String batchName, int batchNumber) {
        ...
        if (getAge() < 18) { // because age is final in Person class we gave condition in constructor
